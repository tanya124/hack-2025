...
class OldChurchSlavonicBot:
    """Main bot class for Old Church Slavonic learning"""
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        welcome_message = (
            ...
            "🏛️ **Бот для изучения старославянского языка**\n\n"
            "Здесь вы изучите основы старославянского языка через короткие уроки "
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        help_message = (
            ...
            "Удачи в изучении старославянского языка! 📚"
        )
    ...
    def run(self):
        """Start the bot"""
        logger.info("Starting Old Church Slavonic Bot...")
